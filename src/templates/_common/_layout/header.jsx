        ...
        <div id='deriv__header' className='header__menu-items'>
            ...
            <div className='header__menu-right is-logout'>
                <div className='header__btn'>
                    ...
                    <a id='btn__login' className='btn btn--tertiary header__btn-login' style={{ display: 'none' }}><Localize i18n_default_text='Log in' /></a>
                    <a id='btn__signup' className='btn btn--primary header__btn-signup' style={{ display: 'none' }}><Localize i18n_default_text='Sign up' /></a>
                </div>
            </div>
        </div>
        <MobileMenu />
